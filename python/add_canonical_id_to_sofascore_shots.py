"""
Acrescenta benfica_match_id aos remates do Sofascore.
...
- data/sofascore/processed/
  benfica_2025_26_shots_canonical.csv
"""
...
print("Remates totais:", len(result))
print("Remates da Liga:", len(liga))
print(
    "Remates da Liga com ID interno:",
    liga["benfica_match_id"].notna().sum()
)
print(
    "Remates da Liga sem ID interno:",
